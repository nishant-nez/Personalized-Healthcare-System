                    ...
                    <div className="mx-auto grid w-[350px] gap-6">
                        ...
                        <div className="grid gap-4">
                            <div className="grid gap-2">
                                <Label htmlFor="name" className="dark:text-gray-300">First Name</Label>
                                <Input
                                    id="fname"
                                    type="text"
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="name" className="dark:text-gray-300">Last Name</Label>
                                <Input
                                    id="lname"
                                    type="text"
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="re_password" className="dark:text-gray-300">Confirm Password</Label>
                                <Input
                                    id="re_password"
                                    type="password"
                                    value={re_password}
                            ...
                            {isLoading ?
                                ...
                                :
                                <Button type="submit" className="w-full dark:white" onClick={onSubmit}>
                                    Signup
                                </Button>
                            }
